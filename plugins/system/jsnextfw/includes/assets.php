...
class JsnExtFwAssets
{
	...
	protected static $assets = array(
		 ...
		 * 3rd-party assets.
		 */
		'base64' => 'assets/vendors/base64/base64.min.js',
		'bootstrap' => array(
			'assets/vendors/bootstrap/css/bootstrap.css'
		),
		'cookie' => 'assets/vendors/cookie/js.cookie.js',
		'flag-icon' => 'assets/vendors/flag-icon/css/flag-icon.min.css',
		'font-awesome' => 'assets/vendors/font-awesome/css/font-awesome.min.css',
		'interact' => 'assets/vendors/interact/interact.min.js',
		'noty' => array(
			'assets/vendors/noty/animate.css',
			'jquery',
			'assets/vendors/noty/jquery.noty.js'
		),
		'popper' => 'assets/vendors/popper/popper.min.js',
		'react' => array(
			'assets/vendors/react/react.min.js',
			'assets/vendors/react/react-dom.min.js'
		),
		'sortable' => 'assets/vendors/sortable/html.sortable.min.js',
		'spectrum' => array(
			'assets/vendors/spectrum/spectrum.css',
			'assets/vendors/spectrum/spectrum.js'
		),
		'underscore' => 'assets/vendors/underscore/underscore-min.js'
	);
