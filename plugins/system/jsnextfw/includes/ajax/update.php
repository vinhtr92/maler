...
class JsnExtFwAjaxUpdate extends JsnExtFwAjax
{
	...
	public function downloadAction()
	{
		...
		{
			throw new Exception('JSN_EXTFW_AJAX_INVALID_PARAMETERS');
		}
		...
		{
			$downloader = new JsnExtFwAjaxDownloader();
	...
	public function installAction()
	{
		...
		{
			throw new Exception('JSN_EXTFW_UPDATE_NOT_FOUND_UPDATE_PACKAGE');
		}
