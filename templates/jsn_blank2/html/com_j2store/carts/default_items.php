					...
					<td>
					  ...
					  <?php if($this->params->get('show_qty_field', 1)) : ?>
						<td>
							...
							<a class="link-button button-light j2store-remove remove-icon" href="<?php echo JRoute::_('index.php?option=com_j2store&view=carts&task=remove&cartitem_id='.$item->cartitem_id); ?>">
